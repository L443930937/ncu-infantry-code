...
static CanTxMsgTypeDef  CANSend_Cilent;
/* 函数原型声明 ----------------------------------------------------------*/
...
void CAN_Send_YT( CAN_HandleTypeDef * hcan, int16_t yaw_angle, int16_t yaw_speed , uint8_t flag , uint8_t flag1 , uint8_t remote_flag)
{
			CANSend_YT.DLC = 0x08;
...
void CAN_Send_cilent( CAN_HandleTypeDef * hcan, uint8_t flag0, uint8_t flag1 , uint8_t flag2 ,uint8_t flag3)//待续
{
			...
			CANSend_Cilent.Data[0]=flag0;
			CANSend_Cilent.Data[1]=flag1;
			CANSend_Cilent.Data[2]=flag2;
			CANSend_Cilent.Data[3]=flag3;
			CANSend_Cilent.Data[4]=0;
			CANSend_Cilent.Data[5]=0;
			CANSend_Cilent.Data[6]=0;
			CANSend_Cilent.Data[7]=0;
	
			hcan->pTxMsg = &CANSend_Cilent;
			HAL_CAN_Transmit(hcan,30);
}	
