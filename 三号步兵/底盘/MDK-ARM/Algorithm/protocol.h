...
typedef  enum                 //Ã¶¾ÙÀàĞÍ£¬ÃüÁîid_±ä¸ü
 {
   red_hero = 0x0101 ,
   red_Engineering = 0x0102,
   red_Infantry_3  = 0x0103,
   red_Infantry_4  = 0x0104,
   red_Infantry_5  = 0x0105,
   red_sentinel    = 0x0106,
   blue_hero = 0x0111,
   blue_Engineering = 0x0112,
   blue_Infantry_3  = 0x0113,
   blue_Infantry_4  = 0x0114,
   blue_Infantry_5  = 0x0115,
   blue_sentinel    = 0x0116,
 }robotid; 
...
{
   uint8_t data[10];
} robot_interactive_data_t;                 //½»»¥Êı¾İ³¤¶È×Ô¶¨Òå
